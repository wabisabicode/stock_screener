...
from stock_screener.utils import get_last_value, get_non_null_table
...
def main():
    ...
    for stockname in stocks_list:
        if stockname != '':
            ...
            mrq_gp_mgn, mrq_ocf_mgn, mrq_fcf_mgn = get_mrq_gp_margin(stock)
            av_gp_mgn, av_ocf_mgn, av_fcf_mgn = get_ann_gp_margin(stock)
            ...
            print(
                ...
                "{:4.0f}% \t {:4.0f}% \t".format(
                    mrq_ocf_mgn * 100, av_ocf_mgn * 100),
                "{:4.0f}% \t {:4.0f}% \t".format(
                    mrq_fcf_mgn * 100, av_fcf_mgn * 100),
